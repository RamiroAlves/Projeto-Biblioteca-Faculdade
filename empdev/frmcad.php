    ...
    <div class="content-wrapper">
      ...
      <div class="content-header">
        <div class="container-fluid">
          <div class="row mb-2">
            <div class="col-sm-6">
              <h1 class="m-0 text-dark">Cadastro de Acervo</h1>
            </div><!-- /.col -->
          </div><!-- /.row -->
        </div><!-- /.container-fluid -->
      </div>
            ...
            <div class="col-lg-12">
              <div class="card card-primary card-outline">
                ...
                <?php
                  ...
                  ?>
                  <form id="" name="f1" action="../controle/acervo/salvar.php" method="POST" onsubmit="return validar()">
                    ...
                    <div class="form-group mr-2 ml-2">
                      <div class="col-md-12">
                        ...
                        <div class="input-group mb-2">
                          ...
                          <input name="titulo" type="text" class="form-control" placeholder="Informe o título"
                            required>
                        </div>
                      </div>
                    </div>
                    <div class="form-group mr-2 ml-2">
                      <div class="col-md-12">
                        ...
                        <div class="input-group mb-2">
                          ...
                          <input name="ano_publicacao" type="text" class="form-control" placeholder="Informe o ano de publição"
                            required>
                        </div>
                      </div>
                    </div>
                    <div class="form-group mr-2 ml-2">
                      <div class="col-md-12">
                        ...
                        <div class="input-group mb-2">
                          ...
                          <input name="editora" type="text" class="form-control" placeholder="Informe a editora"
                            required>
                        </div>
                      </div>
                    </div>
                    <div class="form-group mr-2 ml-2">
                      <div class="col-md-12">
                        ...
                        <div class="input-group mb-2">
                          ...
                          <input name="npaginas" type="text" class="form-control" placeholder="Informe o número de páginas"
                            required>
                        </div>
                      </div>
                    </div>
                    <div class="form-group mr-2 ml-2">
                      <div class="col-md-12">
                        ...
                        <div class="input-group mb-2">
                          ...
                          <input name="exemplar" type="text" class="form-control" placeholder="Informe o exemplar"
                            required>
                        </div>
                      </div>
                    </div>
