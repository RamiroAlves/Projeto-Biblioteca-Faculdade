    ...
    <aside class="main-sidebar sidebar-dark-primary elevation-4">
      ...
      <div class="sidebar">
        ...
        <div class="user-panel mt-3 pb-3 mb-3 d-flex">
          ...
          <div class="info">
            <a href="#" class="d-block">Emprestimo develoção</a>
          </div>
        </div>
    ...
    <div class="content-wrapper">
      ...
      <div class="content-header">
        <div class="container-fluid">
          <div class="row mb-2">
            <div class="col-sm-6">
              <h1 class="m-0 text-dark">Busca de Emprestimos/Devoluções</h1>
            </div><!-- /.col -->
          </div><!-- /.row -->
        </div><!-- /.container-fluid -->
      </div>
            ...
            <div class="col-lg-12">
              <div class="card card-primary card-outline">
                ...
                <div class="form-group mr-2 ml-2">
                  ...
                  Legenda: <span class="badge badge-danger">Em atraso</span>&nbsp;<span class="badge badge-success">No prazo</span>
                  </div>
                  <!-- Divisória da tabela -->
                      ...
                      <tbody>
                        <?php
                            if(isset($_POST['texto'])){
                              ...
                              $sql = "select *, date_format(data, '%d/%m/%Y') as databr, timestampdiff(DAY, data, now()) as qtd_dias from vempdev where titulo like '%".$_POST['texto']."%' and data_dev is null";

                              //Dados da conculta
                              $busca = $empdevCRUD->consultar($sql);
                              ...
                              foreach($busca as $linhas){
                                  echo '
                                  <tr>
                                      <td>'.$linhas['id_empdev'].'</td>';
                                  if($linhas['qtd_dias'] > 10){
                                  echo'    <td><span class="badge badge-danger">'.$linhas['leitor'].'</span></td>';
                                   } else {
                                  echo'    <td><span class="badge badge-success">'.$linhas['titulo'].'</span></td>
                                      <td>'.$linhas['databr'].'</td>
                                      <td>'.$linhas['qtd_dias'].'</td>
                                      <td>
                                        <a href="frmalt.php?id='.$linhas['id_empdev'].'" titulo="Alterar" class="btn btn-sm btn-outline-info"><i
                                            class="fa fa-book"></i>&nbsp;Devolver</a>
                                        <a href="../controle/acervo/apagar.php?id='.$linhas['id_empdev'].'" onclick="validarDelete()" title="Excluir" class="btn btn-sm btn-outline-danger"><i
                        ...
                        <tr>
                          ...
                          <td>
                            <a href="frmalt.php" class="btn btn-sm btn-outline-info"><i
                                class="fa fa-edit"></i>&nbsp;Devolver</a>
