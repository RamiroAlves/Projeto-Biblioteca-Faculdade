                    ...
                    <div class="form-group mr-2 ml-2">
                      <div class="col-md-12">
                        ...
                        <div class="input-group mb-2">
                          ...
                          <input value="<?php echo $busca->getTitulo(); ?>" name="titulo" type="text" class="form-control" placeholder="Informe o título"
                            required>
                        </div>
                      </div>
                    </div>
                    <div class="form-group mr-2 ml-2">
                      <div class="col-md-12">
                        ...
                        <div class="input-group mb-2">
                          ...
                          <input value="<?php echo $busca->getAno_publicacao(); ?>" name="ano_publicacao" type="text" class="form-control" placeholder="Informe o ano de publição"
                            required>
                        </div>
                      </div>
                    </div>
                    <div class="form-group mr-2 ml-2">
                      <div class="col-md-12">
                        ...
                        <div class="input-group mb-2">
                          ...
                          <input value="<?php echo $busca->getEditora(); ?>" name="editora" type="text" class="form-control" placeholder="Informe a editora"
                            required>
                        </div>
                      </div>
                    </div>
                    <div class="form-group mr-2 ml-2">
                      <div class="col-md-12">
                        ...
                        <div class="input-group mb-2">
                          ...
                          <input value="<?php echo $busca->getNpaginas(); ?>" name="npaginas" type="text" class="form-control" placeholder="Informe o número de páginas"
                            required>
                        </div>
                      </div>
                    </div>
                    <div class="form-group mr-2 ml-2">
                      <div class="col-md-12">
                        ...
                        <div class="input-group mb-2">
                          ...
                          <input value="<?php echo $busca->getExemplar(); ?>" name="exemplar" type="text" class="form-control" placeholder="Informe o exemplar"
                            required>
                        </div>
                      </div>
                    </div>
